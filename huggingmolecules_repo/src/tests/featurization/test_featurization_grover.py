...
from tests.featurization.expected.featurization_expected_grover import (
    expected_batch,
...
class FeaturizationApiGroverTest(FeaturizationApiTestBase, unittest.TestCase):
    ...
    expected_encoded_smiles = {
        pretrained: expected_encoded_smiles for pretrained in config_arch_dict.keys()
    }
    expected_batch = {
        pretrained: expected_batch for pretrained in config_arch_dict.keys()
    }
